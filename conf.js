  ...
  http: {
    routes: {
      ...
      private: {
        ...
        'post /videos/:id/chapters/:poiid': 'app/server/controllers/VideoController.updateChapterAction',
        'post /videos/:id/chapters': 'app/server/controllers/VideoController.updateChapterAction',
        'post /videos/:id/tags/:poiid': 'app/server/controllers/VideoController.updateTagAction',
        ...
        'delete /videos/:id/chapters/:poiids': 'app/server/controllers/VideoController.removeChaptersAction',
        'delete /videos/:id/tags/:poiids': 'app/server/controllers/VideoController.removeTagsAction',
